...
def producer_function():
    sample_messages = [
        {"message_id": 1, "content": "Cats"},
        {"message_id": 2, "content": "Dogs"},
        {"message_id": 3, "content": "Guinea Pigs"},
    ]
...
@dag(tags=["Pattern Example", "Inference Execution"])
def inference_execution_producer_dag():
...
inference_execution_producer_dag()